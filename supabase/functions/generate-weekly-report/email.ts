...
function buildEmailHtml(params: SendReportEmailParams): string {
  const { recipientName, weekEnding, signedUrl, complianceStatus, treatmentCount, nearMissCount, projectName } = params;
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <div style="padding: 32px 24px;">
      ...
      <div style="border-top: 1px solid #e5e7eb; padding-top: 24px; margin-top: 32px;">
        <p style="margin: 0; color: #6b7280; font-size: 14px; line-height: 1.5;">
          This report was automatically generated by SiteMedic. If you have any questions about the data
    ...
    <div style="background-color: #f9fafb; padding: 24px; text-align: center; border-top: 1px solid #e5e7eb;">
      <p style="margin: 0; color: #9ca3af; font-size: 12px;">
        © ${new Date().getFullYear()} SiteMedic. All rights reserved.
      </p>
    </div>
  </div>
</body>
