...
const EXAMPLE_MILES = 12;             // Typical 12-mile round-trip
...
export function CompensationSettings({
  ...
  // Live preview of payout for an example shift
      ...
      <div className="bg-gray-700/20 border border-gray-700/40 rounded-xl p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-gray-400 text-xs font-medium uppercase tracking-wide">
            Example 8-hr Standard Shift · {EXAMPLE_MILES} miles
          </span>
        </div>
        <div className="grid grid-cols-3 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs">{EXAMPLE_MILES} mi × {HMRC_MILEAGE_RATE_PENCE}p</p>
          </div>
