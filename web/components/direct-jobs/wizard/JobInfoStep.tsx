 ...
 *
 * Collects job name, type, description, special requirements, setting, and attendance.
 * Mirrors BasicInfoStep.tsx from the marketplace event wizard.
 */
...
export default function JobInfoStep({ errors }: Props) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <input
          ...
          placeholder="e.g. Glastonbury Festival Medical Cover 2026"
        />
        {errors?.event_name && (
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
          placeholder="Describe the job and what medical cover is needed..."
        />
      </div>
