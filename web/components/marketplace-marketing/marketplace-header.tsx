...
export default function MarketplaceHeader() {
  ...
  const navLinks = [
    ...
    { href: '/marketplace/for-clients', label: 'For Clients' },
    { href: '/marketplace/for-companies', label: 'For Companies' },
    { href: '/marketplace/faq', label: 'FAQ' },
    { href: '/', label: 'ASG Direct' },
  ];
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/marketplace" className="flex items-center gap-2.5 group">
            <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-blue-700 transition">
              <span className="text-white text-[10px] font-bold tracking-tight">SM</span>
            </div>
            ...
            <div className="sm:hidden text-base font-bold text-slate-900">SiteMedic</div>
          </Link>
