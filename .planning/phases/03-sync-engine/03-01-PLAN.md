...
must_haves:
  truths:
    ...
    - "Background task processes data sync only; photo upload integration deferred to Plan 03-03"
  artifacts:
...
6. Background task processes data sync only; photo upload integration deferred to Plan 03-03
</success_criteria>
