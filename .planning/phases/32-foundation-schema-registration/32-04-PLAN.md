...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>Stripe Connect Express onboarding for marketplace companies: new Edge Function action (business_type='company'), API route, and callback page handling both completion and refresh scenarios.</what-built>
  <how-to-verify>
