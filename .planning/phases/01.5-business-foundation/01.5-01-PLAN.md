...
must_haves:
  truths:
    ...
    - "Invoice number auto-increments (INV-2026-001 format)"
    - "Pricing breakdown shows base_rate * hours * (1 + urgency%) + travel + out_of_territory, then 20% VAT"
  artifacts:
  ...
  key_links:
    - from: "supabase/functions/calculate-pricing/index.ts"
      ...
      pattern: "supabase.*from.*bookings"
