...
<task type="auto">
  ...
  - Grep the file for `payslip:payslips` to confirm the join is present
...
- Payslips join includes `payslip:payslips(id, pdf_url, payslip_reference)`
</verification>
