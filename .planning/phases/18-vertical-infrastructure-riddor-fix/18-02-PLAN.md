...
must_haves:
  truths:
    - "The RIDDOR detector contains a NON_RIDDOR_VERTICALS array and an early return before detectRIDDOR() is called, for treatments whose effective vertical is in that list"
