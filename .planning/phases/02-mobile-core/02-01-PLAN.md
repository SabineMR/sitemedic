...
must_haves:
  truths:
    - "All Phase 2 dependencies are installed and resolvable"
    - "Shared UI components render with 56x56pt minimum tap targets"
    - "Taxonomy data is available as typed arrays for pick lists"
  artifacts:
