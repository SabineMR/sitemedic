...
must_haves:
  ...
  key_links:
    ...
    - from: "mobile/app/treatment/templates.tsx"
      to: "mobile/components/forms/WorkerSearchPicker.tsx"
      via: "Import WorkerSearchPicker from Plan 03 for worker selection"
      pattern: "import.*WorkerSearchPicker.*from.*components/forms/WorkerSearchPicker"
---
...
<task type="auto">
  ...
  **Critical imports from prior plans:**
  - Import WorkerSearchPicker from `../../components/forms/WorkerSearchPicker` (built in Plan 03 -- provides worker search with inline quick-add)
...
- WorkerSearchPicker imported from Plan 03 in templates.tsx
</verification>
