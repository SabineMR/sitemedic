...
must_haves:
  truths:
    ...
    - "VERTICAL_CONFIG['construction'].certOrdering starts with ['CSCS', 'CPCS', 'IPAF', 'Gas Safe', 'FREC 3']"
...
<task type="auto">
  ...
  <done>
    ...
    - VERTICAL_CONFIG['construction'].certOrdering[4] === 'FREC 3'
    - VERTICAL_CONFIG['construction'].pdfGenerator === 'riddor-f2508-generator'
...
3. Read the file and confirm: construction entry has all 7 fields, certOrdering starts with ['CSCS', 'CPCS', 'IPAF', 'Gas Safe', 'FREC 3'], riddorApplies is true
...
- construction certOrdering satisfies CONST-02 pattern: CSCS, CPCS, IPAF, Gas Safe, FREC 3 in the leading positions
