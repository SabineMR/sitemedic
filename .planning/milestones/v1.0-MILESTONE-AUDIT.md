...
tech_debt:
  - phase: 01-foundation
    items:
      - "UI screens missing: login, signup, biometric settings"
      - "Infrastructure complete, deferred to Phase 2 intentionally"
  - phase: 01.5-business-foundation
    items:
      - "External service configuration: Stripe API keys, Google Maps API key"
      - "Status: pending_setup"
  - phase: 04.5-marketing-booking
    items:
      - "Confirmation page uses mock booking data instead of database fetch"
      - "Impact: Incorrect pricing shown, recurring details not displayed"
---
...
**3 phases with tech debt:**
1. Phase 01-foundation: UI screens deferred to Phase 2 (intentional)
2. Phase 01.5-business-foundation: External service keys pending setup
3. Phase 04.5-marketing-booking: Confirmation page mock data (cosmetic)
