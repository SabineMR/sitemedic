        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-7 shadow-sm">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-1">£149<span className="text-lg text-slate-400 font-normal">/mo</span></div>
            ...
            <div className="bg-sky-600 rounded-2xl border border-sky-500 p-7 shadow-xl relative">
              ...
              <div className="text-4xl font-bold text-white mb-1">£299<span className="text-lg text-sky-200 font-normal">/mo</span></div>
